...
expectDeclaration('.status-table-scroll', 'box-shadow', 'inset 0 1px 0 color-mix(in srgb, var(--text) 4%, transparent)', tableBlock);
expectDeclaration('.status-table-scroll', 'scrollbar-color', 'var(--border) var(--surface)', tableBlock);
expectDeclaration('.status-table-scroll:focus-visible', 'outline', '2px solid var(--accent)', tableBlock);
expectDeclaration('.status-table', 'color', 'var(--text)', tableBlock);
expectDeclaration('.status-table caption', 'padding', 'var(--s-3) var(--s-3) var(--s-2)', tableBlock);
expectDeclaration('.status-table caption', 'background', 'var(--surface-raised)', tableBlock);
